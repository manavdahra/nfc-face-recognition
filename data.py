...
def createDirectory(path, access_rights):
...
def collect_data(child_upload):
    ...
    createDirectory(constants.CHILD_DATASET_LOCATION_FORMAT.format(child_id), 0o755)
    ...
    try:
        ...
        # arr = image_to_numpy.load_image_file(constants.CHILD_DATASET_LOCATION_FORMAT.format(child_id) + '/{0}.jpg'.format(time.time()))
